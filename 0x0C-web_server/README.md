#0x0C-web_server
in this project i will attempt to transfer files from one server to another,
install NGINX Web server and familiariase myself with a purchase of a domain.
